...
stage_tols = {1: 1e-14, 2: 1e-14, 3: 1e-14}
...
for s, per_var in runs.items():
    for var_name, (h, err) in per_var.items():
        print(f"Radau IIA, s={s}, {var_name} observed order:", empirical_order(h, err))
...
triangle_positions = {
    "y": {1: (0.5, -0.3), 3: (0.5, 3.5), 5: (0.125, 8.5)},
    "w": {1: (0.5, -0.1), 2: (0.5, 1.5), 3: (0.5, 3.05)},
}
