...
axes = plot_convergence(sol_dict, combined=COMBINED_PLOT, title="Partitioned RK convergence for the 2-pipe network")

# theoretical orders: rho/q -> 2s-2 (s=2 -> 2, s=3 -> 4), lambda -> s (even) or s-1 (odd) -> 2 for both
triangle_positions = {
    "rho": {2: (0.5, -0.3), 4: (0.5, 3.5), 6: (0.1, 5.7)},# , 6: (0.5, -0.3),},
    "q": {2: (0.5, -0.3), 4: (0.5, 3.0), 6: (0.5, 6.5)}, # 6: (0.5, -0.3),},
    # "lambda": {2: (0.4, 2.2),}, # 3: (0.8, 0.7)},
    "lambda": {2: (0.4, 2.9), 4: (0.4, 5.7)}
}
